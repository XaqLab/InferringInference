...
"""
r_brain = np.load('../results/Experiment4/recordings-05/r_brain_ICA.npy')
y       = np.load('../results/Experiment4/recordings-05/y_ICA.npy')
...
"""
r_brain = np.load('../results/Experiment4/recordings-05/r_brain_EM.npy')
y       = np.load('../results/Experiment4/recordings-05/y_EM.npy')
...
np.save('./Loglikelihood-vs-Nshat/LL_Nshat'+str(Ns_hat)+'_trial'+str(trial), np.array(LLVec))
